  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-in fade-in duration-200">
      <div
        ...
        className="bg-[#0F172A] text-white w-full max-w-lg rounded-3xl shadow-2xl border border-zinc-800 overflow-hidden flex flex-col relative"
      >
        ...
        <div className="p-6">
          ...
          {step === 'playing' && (
            <div className="space-y-5">
              ...
              <div className="relative bg-zinc-950 rounded-2xl overflow-hidden border border-zinc-800 aspect-video flex flex-col items-center justify-center p-4 text-center group">
                <div className="absolute inset-0 bg-gradient-to-br from-[#6C2BD9]/20 via-transparent to-[#B8F500]/10 pointer-events-none"></div>

                <div className="w-14 h-14 rounded-2xl bg-[#6C2BD9] text-[#B8F500] flex items-center justify-center shadow-lg mb-3">
                  <Play className="w-7 h-7 fill-[#B8F500] ml-0.5" />
                </div>

                <h4 className="text-base font-bold text-white relative z-10">{opportunity.title}</h4>
                <p className="text-xs text-zinc-400 mt-1 max-w-xs relative z-10">
                  Approved partner opportunity. Please complete the full interaction to qualify.
                </p>

                <div className="absolute top-3 right-3 bg-black/70 backdrop-blur-xs px-2.5 py-1 rounded-full border border-zinc-700 text-xs font-mono font-bold text-[#B8F500] flex items-center gap-1.5">
              ...
              <div className="space-y-1.5">
                <div className="flex justify-between text-xs text-zinc-400 font-medium">
                  ...
                  <span className="text-[#B8F500] font-mono">{progressPercent}%</span>
                </div>
              ...
              <div className="bg-zinc-900/60 rounded-xl p-3 border border-zinc-800/80 flex items-center justify-between text-xs">
                <span className="text-zinc-400">Guaranteed Reward:</span>
                <span className="font-extrabold text-[#B8F500] text-sm">+{opportunity.reward_points} Points</span>
              </div>
            </div>
          )}
          ...
          {step === 'rewarded' && claimedData && (
            <div className="py-6 text-center space-y-5 animate-in zoom-in-95 duration-200">
              <div className="w-16 h-16 rounded-3xl bg-[#B8F500] text-[#0F172A] mx-auto flex items-center justify-center shadow-xl shadow-[#B8F500]/20">
                <CheckCircle2 className="w-10 h-10 stroke-[2.5]" />
              </div>

              <div>
                <span className="text-xs font-bold uppercase tracking-wider text-[#B8F500] block mb-1">
              ...
              <div className="bg-zinc-900 rounded-2xl p-4 border border-zinc-800 text-left space-y-2 text-xs">
              ...
              <div className="pt-2">
                <button
                  ...
                  onClick={onClose}
                  className="w-full py-3 rounded-xl bg-[#B8F500] hover:bg-[#A3DC00] text-[#0F172A] font-extrabold text-sm shadow-md transition-all flex items-center justify-center gap-2"
                >
          ...
          {step === 'error' && (
            <div className="py-10 text-center space-y-4">
              ...
              <button
                onClick={onClose}
                className="px-6 py-2.5 rounded-xl bg-zinc-800 hover:bg-zinc-700 text-white font-semibold text-sm transition-colors"
              >
                Close & Return
              </button>
            </div>
